...
//
// The pointer is intrinsically a cursor that points to the current text segment.
...
func (s Style) With(fs ...Formatter) Style {
	// Force a copy of the slice to avoid multiple calls to With interfering.
